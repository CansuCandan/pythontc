...
class Kullanicilar(models.Model):
    ...
    ulke            = models.CharField(_('Ülke'), max_length=100, default=_('Türkiye'))
    sehir           = models.CharField(_('Şehir'), max_length=120, default=_('İstanbul'))
    yas             = models.PositiveIntegerField(_('Yaş'))
